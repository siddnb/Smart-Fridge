...
var _ImageAnalysisByURL200ResponseNutritionCalories = _interopRequireDefault(require("./ImageAnalysisByURL200ResponseNutritionCalories"));
 ...
 * @version 1.1
 */
var ImageAnalysisByURL200ResponseNutrition = /*#__PURE__*/function () {
  /**
   ...
   */
  function ImageAnalysisByURL200ResponseNutrition(recipesUsed, calories, fat, protein, carbs) {
    _classCallCheck(this, ImageAnalysisByURL200ResponseNutrition);
   ...
   */
  _createClass(ImageAnalysisByURL200ResponseNutrition, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('calories')) {
          obj['calories'] = _ImageAnalysisByURL200ResponseNutritionCalories["default"].constructFromObject(data['calories']);
        }
        if (data.hasOwnProperty('fat')) {
          obj['fat'] = _ImageAnalysisByURL200ResponseNutritionCalories["default"].constructFromObject(data['fat']);
        }
        if (data.hasOwnProperty('protein')) {
          obj['protein'] = _ImageAnalysisByURL200ResponseNutritionCalories["default"].constructFromObject(data['protein']);
        }
        if (data.hasOwnProperty('carbs')) {
          obj['carbs'] = _ImageAnalysisByURL200ResponseNutritionCalories["default"].constructFromObject(data['carbs']);
        }
      }
      return obj;
    }
...
var _default = ImageAnalysisByURL200ResponseNutrition;
