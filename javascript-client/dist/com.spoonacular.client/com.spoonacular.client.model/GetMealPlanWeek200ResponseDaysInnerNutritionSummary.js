...
var _GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner = _interopRequireDefault(require("./GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner"));
 ...
 * @version 1.1
 */
var GetMealPlanWeek200ResponseDaysInnerNutritionSummary = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetMealPlanWeek200ResponseDaysInnerNutritionSummary(nutrients) {
    _classCallCheck(this, GetMealPlanWeek200ResponseDaysInnerNutritionSummary);
   ...
   */
  _createClass(GetMealPlanWeek200ResponseDaysInnerNutritionSummary, null, [{
    key: "initialize",
    value: function initialize(obj, nutrients) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('nutrients')) {
          obj['nutrients'] = _ApiClient["default"].convertToType(data['nutrients'], [_GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner["default"]]);
        }
      }
      return obj;
    }
...
var _default = GetMealPlanWeek200ResponseDaysInnerNutritionSummary;
